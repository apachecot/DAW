...
<html>
    <head>
        ...
        <title>Caprabo a casa - Alta producto</title>
        <?php
    ...
    <body>
        ...
        <?php include 'cabecera.php'; ?>
         ...
         <?php echo Form::open(array('action'=>'ProductosController@altaProductos', 'class'=>'form-horizontal')) ?>
        <div class="container">
            <div id="PanelHotel" class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Alta producto</h3>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <?php echo Form::label('Label3', 'Descripción', array('class' => 'col-lg-2 col-sm-2 control-label'));?>
                        <div class="col-lg-10  col-sm-10 col-md-10">
                            <?php echo Form::text('descripcion', null, array('class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <?php echo Form::label('Label4', 'Precio', array('class' => 'col-lg-2 col-sm-2 control-label'));?>
                        <div class="col-lg-10  col-sm-10 col-md-10">
                            <?php echo Form::text('precio', null, array('class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-sm-10 col-xs-10">
                            <?php echo Form::select('subtipo', $subtipos, null, array('class' => 'form-control'));?> 
                        </div>
                    </div>
                    <div class="form-group">
